...
public class VoltageRequest extends BaseBrickletRequestModule<BrickletVoltage> {

	@Override
	protected BrickletVoltage createDevice(String uid) {
		try {
			return new BrickletVoltage(uid, ConnectionManager.getInstance()
	...
	protected void doWork() {
		...
		if (device != null) {
			try {
				...
				getLogger().log(
						Level.SEVERE,
						"Can't get voltage from bricklet " + uid + " (" + host
								+ ":" + port + ")", e);
			}
		}
	}
